...
default.gui_bg = gui.gui_bg
default.gui_bg_img = gui.gui_bg_img
default.gui_slots = gui.gui_slots
default.get_hotbar_bg = gui.get_hotbar_bg
default.gui_survival_form = gui.gui_survival_form
